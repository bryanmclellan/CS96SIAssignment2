...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, FiltersViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let gender = "male"
        let who = "child"
        search(who: who, age: age, gender: gender)
    }
    ...
    func search(who: String, age: Int, gender: String){
...
//                        print("response \(results["Topics"])")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        else if segue.identifier == "PresentFilters" {
            let filtersVC = segue.destination as! ModalViewController
